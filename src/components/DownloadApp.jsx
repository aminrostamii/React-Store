...
const DownloadApp = () => {
    ...
    <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
        <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium tracking-widest uppercase text-gray-600 ml-10">Everything Here
            </p>
            <div className='flex flex-row justify-center items-center '>
            <img src={mixiM} alt=""  className='w-24 h-24'/>
            <h1 className="py-2 text-4xl font-medium leading-tight title-font">Mixi</h1>
            </div>
        </div>
        <div
            ...
            <button className="inline-flex items-center px-6 py-3 rounded-lg bg-black text-gray-50">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className=" fill-white w-8 h-8 text-gray-50">
				...
				<span className="flex flex-col items-start ml-4 leading-none">
					<span className="mb-1 text-xs  text-slate-100">GET IT ON</span>
					<span className="font-semibold title-font text-slate-100">Google Play</span>
				</span>
			</button>
            <button className="inline-flex items-center px-5 py-3 rounded-lg bg-black text-gray-50">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="fill-white w-8 h-8 text-gray-50">
				...
				<span className="flex flex-col items-start ml-4 leading-none">
					<span className="mb-1 text-xs text-slate-100">Download on the</span>
					<span className="font-semibold title-font text-slate-100">App Store</span>
				</span>
			</button>
        </div>
    </div>
